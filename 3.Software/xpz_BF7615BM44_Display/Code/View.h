...
typedef struct{
	...
	uint8 QueryDeviceStatusSendFlag							: 1;	/*查询设备状态*/
	uint8 SendWashDataSendFlag								: 1;	/*标准洗涤*/
	uint8 SendFunctionTestSendFlag							: 1;	/*维保功能测试*/	
	uint8 ErrorInformationReportingSendFlag					: 1;	/*错误信息上报*/
	
	uint8 SendFunctionSettingSendFlag						: 1;	/*功能设定*/
	uint8 SendParameterCalibrationSendFlag					: 1;	/*参数校准*/
	uint8 SendDryingDataSendFlag							: 1;	/*烘干*/
	uint8 													: 1;
